  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Container(
        ...
        color: Colors
            .transparent, // Nền trong suốt để thấy được background của Scaffold
        ...
        child: Container(
          ...
          child: ClipRRect(
            ...
            child: BottomNavigationBar(
              ...
              elevation:
                  0, // Tắt bóng mặc định của BottomNav (vì ta đã dùng bóng của Container)
